        ...
        <div key={index} className=" ">
          ...
          <div className="w-1/2 text-center absolute md:top-52 md:right-40 lg:right-80 right-28 top-14">
            <div className="space-y-2">
              <p className="px-2 text-[9px] font-semibold uppercase bg-gradient-to-r from-[#cc40f5]  to-[#5b55fd] w-fit rounded-lg text-white">
                {slide.title}
              </p>
            ...
            <div className="mt-4">
              <button className="px-4 py-1 bg-gradient-to-r from-[#cc40f5]  to-[#5b55fd] text-white rounded-2xl text-sm font-semibold">
                Learn More
              </button>
            </div>
          </div>
